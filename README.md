...
- [docsify-simple-themeable](https://github.com/FlippedCodes/docsify-simple-themeable) - A docsify.js plugin to simplify the color selection for [docsify-themable](https://jhildenbiddle.github.io/docsify-themeable).
