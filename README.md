...
- [docsify-lucide-icons](https://github.com/bhaireshm/docsify-lucide) - A simple, clean Docsify plugin to embed Lucide icons directly in your Markdown files. [@bhaireshm](https://github.com/bhaireshm)
